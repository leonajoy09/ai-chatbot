...
|`location`|`string`|(Required)  The Azure region where the VNet should be deployed. Resources integrated with the VNet will need to be located in the same region.  <br><br>Allowed values: `australiaeast, eastus, germanywestcentral, westeurope`|
